...
# Enable inline attachments (not just show the icons)
...
# ref: https://mattprice.me/2020/programmatically-modify-spotlight-ignore/
...
# Transmission.app                                                            #
###############################################################################
# reference: https://github.com/transmission/transmission/blob/master/macosx/Defaults.plist
...
# Use `~/Torrents` to store completed downloads
